...
+------------------------------------------------------------------------------------------+----------+--------------------------+
|`pds-api#202`_ Complete refactoring per API WG discussion on end-point redesign           |          |p.must-have               |
+------------------------------------------------------------------------------------------+----------+--------------------------+
...
.. _roundup-action#82: https://github.com/NASA-PDS/roundup-action/issues/82
.. _roundup-action#81: https://github.com/NASA-PDS/roundup-action/issues/81
