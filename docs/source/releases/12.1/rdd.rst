...
Planned Updates
~~~~~~~~~~~~~~~
- `cloud-tasks#3`_ B12.1 pds.nasa.gov Website Lift-and-Shift Pilot
Project

+-----------------------------------------------------------------+----------+--------+--------------------------+
|Issue                                                            |I&T       |Level   |Priority / Bug Severity   |
+=================================================================+==========+========+==========================+
|`cloud-tasks#9`_ AWS testing for PDS and PDS Engineering sites   ||iandt|   |task    |unknown                   |
+-----------------------------------------------------------------+----------+--------+--------------------------+


- `cloud-tasks#4`_ B12.1 pds-engineering.nasa.gov Website Lift-and-Shift
Pilot Project
...
- `cloud-tasks#5`_ NAIF.nasa.gov Website Lift-and-Shift Pilot Project
...
- `cloud-tasks#8`_ Develop Roadmap and Cost Model for PDS Cloud (no
...
- `cloud-tasks#15`_ Design and Develop Registry Upgrade Strategy (no
parent epic in this repository)
...
Planned Updates
~~~~~~~~~~~~~~~
- `devops#11`_ Implement Continuous Deployment Strategy (no parent epic
in   this repository)
...
- `doi-service#270`_ B12.1 DOI Metadata and Update Functionality
Improvements
...
Planned Updates
~~~~~~~~~~~~~~~
- `doi-ui#60`_ DOI Search Component (no parent epic in this repository)
...
+---------------------------------------------------------------------------------------------------+----------+--------------------------+
|`doi-ui#117`_ Fix DOI Search And DOI UI Integration Bugs                                           ||iandt|   |unknown                   |
+---------------------------------------------------------------------------------------------------+----------+--------------------------+
...
Planned Updates
~~~~~~~~~~~~~~~
- `pds-api#111`_ B12.1 Response Format Improvements (no parent epic in
this repository)
...
+--------------------------------------------------------------------------------------------------+----------+--------------------------+
|`pds-api#164`_ version number invalid according to PEP validation in CI                           ||iandt|   |unknown                   |
+--------------------------------------------------------------------------------------------------+----------+--------------------------+
...
Planned Updates
~~~~~~~~~~~~~~~
- `pds-registry-app#26`_ Manage duplicate products (no parent epic in
this   repository)
...
- `pds-registry-app#190`_ Provide Initial Support for Restricted Access
vs. Public Data
...
- `pds-registry-app#194`_ Populate EN Registry (no parent epic in this
repository)

- `pds-registry-app#199`_ Dockerize Registry Components for Dev and Ops
Deployments
...
- `pds-registry-app#219`_ Re-imagine Registry Handling of Product
Versioning (no parent epic in this repository)
...
+--------------------------------------------------------------------------------------------------------------+----------+--------------------------+
|`pds-registry-app#231`_ the snapshot releases are not created for big-data-harvest-client                     ||iandt|   |unknown                   |
+--------------------------------------------------------------------------------------------------------------+----------+--------------------------+
...
+-------------------------------------------------------------------------------------------------------------+----------+--------------------------+
|`pds-registry-app#241`_ Simplify the readme and procedure to start the registry with docker-compose          |          |unknown                   |
+-------------------------------------------------------------------------------------------------------------+----------+--------------------------+
...
|Issue                                                                     |I&T       |Priority / Bug Severity   |
+==========================================================================+==========+==========================+
|`pds-wds-react#26`_ Fix Material UI Overriding Client App's Styling       ||iandt|   |unknown                   |
+--------------------------------------------------------------------------+----------+--------------------------+
|`pds-wds-react#27`_ Hovering Over Status Value Will Crash A Client App    ||iandt|   |unknown                   |
+--------------------------------------------------------------------------+----------+--------------------------+
|`pds-wds-react#28`_ Hovering Over Status Value Will Crash A Client App    ||iandt|   |unknown                   |
+--------------------------------------------------------------------------+----------+--------------------------+
|`pds-wds-react#29`_ Fix Search Not Running On First Call For Client App   ||iandt|   |unknown                   |
+--------------------------------------------------------------------------+----------+--------------------------+
...
Planned Updates
~~~~~~~~~~~~~~~
- `pds-web-mgmt#1`_ Initial Assessment of Today’s Web Management
Landscape   (no parent epic in this repository)

- `pds-web-mgmt#2`_ Preliminary Design of Migration (no parent epic in
this repository)

- `pds-web-mgmt#3`_ Initial High-level Implementation Plan (no parent
...
Planned Updates
~~~~~~~~~~~~~~~
- `PDS.nasa.gov-UX#77`_ Initial Information Architecture (no parent epic
in this repository)

- `PDS.nasa.gov-UX#78`_ Initial Design Validation and Usability Testing
(no parent epic in this repository)

- `PDS.nasa.gov-UX#100`_ B12.1 Continuation of User Persona and User
Story   Development
...
- `PDS.nasa.gov-UX#101`_ Deploy new Citing PDS Data Web Pages (no parent
epic in this repository)
...
GraphDB   (no parent epic in this repository)
...
- `pds4-information-model#410`_ B12.1 LDDTool / PDS4 IM Documentation
Updates (no parent epic in this repository)

- `pds4-information-model#415`_ CCB-342: NASA, CODMAC, and PDS
Processing   Levels for Science Data Sets (no parent epic in this
repository)
...
+----------------------------------------------------------------------------------------------+----------+--------------------------+
|`registry-api#5`_ AWS cost analysis tag  is not 'Alpha' but instead 'Alfa'                    |          |unknown                   |
+----------------------------------------------------------------------------------------------+----------+--------------------------+
...
- `software-issues-repo#17`_ B12.1 Generate Release Plan (no parent epic
in this repository)
...
Planned Updates
~~~~~~~~~~~~~~~
- `validate#407`_ B12.1 Referential Integrity Improvements (no parent
epic   in this repository)
...
|Issue                                                                       |I&T       |Priority / Bug Severity   |
+============================================================================+==========+==========================+
|`validate#421`_ Improve warning message                                     ||iandt|   |p.must-have               |
+----------------------------------------------------------------------------+----------+--------------------------+
...
=================================
The Engineering Node Software resources are listed in the `Software Catalog (Build 12.1-SNAPSHOT)`_
...
.. _Software Release Summary (B12.1): https://nasa-pds.github.io/releases/B12.1/index.html
