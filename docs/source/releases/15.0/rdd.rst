...
| Issue                                                                            | I&T Status        | Level       | Priority / Bug Severity   |
+==================================================================================+===================+=============+===========================+
| `pds4-information-model#795`_ CCB-7: Missing schematron rule - bundle_to_targets | |:yellow_circle:| | requirement | p.must-have               |
+----------------------------------------------------------------------------------+-------------------+-------------+---------------------------+
...
| Issue                                               | I&T Status        | Priority / Bug Severity   |
+=====================================================+===================+===========================+
| `planetarydata.org#24`_ Old link to PSA             | |:yellow_circle:| | s.medium                  |
+-----------------------------------------------------+-------------------+---------------------------+
...
| Issue                                                                         | I&T Status        | Priority / Bug Severity   |
+===============================================================================+===================+===========================+
| `registry-legacy-solr#130`_ Unable to set custom facet fields (`facet.field`) | |:yellow_circle:| | s.critical                |
+-------------------------------------------------------------------------------+-------------------+---------------------------+
...
| Issue                                                                         | I&T Status        | Priority / Bug Severity   |
+===============================================================================+===================+===========================+
| `search-ui-legacy#35`_ Faceting no longer works since XssUtils was introduced | |:yellow_circle:| | s.critical                |
+-------------------------------------------------------------------------------+-------------------+---------------------------+
...
.. list-table:: 
   ...
   * - `User Guide <https://github.com/NASA-PDS/updart#readme>`_
     - `Github Repo <https://github.com/NASA-PDS/updart>`_
     - `Issue Tracking <https://github.com/NASA-PDS/updart/issues>`_ 
     - `Requirements <https://github.com/NASA-PDS/updart/tree/main/docs/requirements>`_ 
     - `Stable Release <https://github.com/NASA-PDS/updart/releases/latest>`_ 
     - `Dev Release <https://github.com/NASA-PDS/updart/releases>`_ 
...
| Issue                                                            | I&T Status        | Priority / Bug Severity   |
+==================================================================+===================+===========================+
| `updart#7`_ As a user, I want to support search-after pagination | |:yellow_circle:| | p.should-have             |
+------------------------------------------------------------------+-------------------+---------------------------+
...
| Issue                                                                                  | I&T Status        | Priority / Bug Severity   |
+========================================================================================+===================+===========================+
| `validate#675`_ Cutover to using new Registry API for generating context products json | |:yellow_circle:| | p.must-have               |
+----------------------------------------------------------------------------------------+-------------------+---------------------------+
...
.. _updart#7: https://github.com/NASA-PDS/updart/issues/7
