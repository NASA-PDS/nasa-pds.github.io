...
.. list-table:: 
   ...
   * - `User Guide <https://github.com/NASA-PDS/cloud-strategy#readme>`_
     ...
     - `Backlog <https://github.com/NASA-PDS/cloud-strategy/issues?q=is%3Aopen+is%3Aissue+label%3Abacklog>`_ 
...
Planned Updates
~~~~~~~~~~~~~~~
- `cloud-strategy#2`_ B12.0 Refine AWS Registry Deployment Strategy (no
...
- `devops#3`_ Develop and implement PDS CD Strategy (no epic in this
repository)

- `devops#9`_ Improvements per JPL-PDS Open Source Policy (no epic in
this   repository)
...
.. list-table:: 
   ...
   * - `User Guide <https://github.com/NASA-PDS/operations#readme>`_
     ...
     - `Backlog <https://github.com/NASA-PDS/operations/issues?q=is%3Aopen+is%3Aissue+label%3Abacklog>`_ 
...
|Issue                                                           |I&T       |Priority / Bug Severity   |
+================================================================+==========+==========================+
|`operations#141`_ Forward old proposing pages to new web page   ||iandt|   |unknown                   |
+----------------------------------------------------------------+----------+--------------------------+
...
- `pds-api#79`_ [pds-api] PDS Core Registry (no epic in this repository)
...
- `pds-doi-service#179`_ Develop DataCite Interface
...
Planned Updates
~~~~~~~~~~~~~~~
- `pds-registry-app#26`_ Manage duplicate products (no epic in this
repository)

- `pds-registry-app#152`_ Pilot DN Registry + API AWS Deployments (no
epic   in this repository)
...
- `PDS.nasa.gov-UX#75`_ User Testing for NASA CMS Trade Study (no epic
in   this repository)

- `PDS.nasa.gov-UX#79`_ Initial Visual Design (no epic in this
repository)
...
+-------------------------------------------------------------------------------------------------------------+----------+--------------------------+
|`PDS.nasa.gov-UX#80`_ Create new Training page                                                               |          |p.must-have               |
+-------------------------------------------------------------------------------------------------------------+----------+--------------------------+
...
- `pds4-information-model#350`_ B12.0 PDS4 Information Model SCR
...
+------------------------------------------------------------------------------------------------------------------------------+----------+--------------------------+
|`pds4-information-model#387`_ As an operator, I want to be able to convert from XML to RDF using the PDS4 Information Model   ||iandt|   |p.must-have               |
+------------------------------------------------------------------------------------------------------------------------------+----------+--------------------------+
...
.. _cloud-strategy#2: https://github.com/NASA-PDS/cloud-strategy/issues/2
...
.. _operations#141: https://github.com/NASA-PDS/operations/issues/141
...
.. _pds4-information-model#403: https://github.com/NASA-PDS/pds4-information-model/issues/403
.. _pds4-information-model#387: https://github.com/NASA-PDS/pds4-information-model/issues/387
